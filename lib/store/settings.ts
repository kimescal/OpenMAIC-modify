...
const migrateFromOldStorage = () => {
  ...
  let modelId = COMPANY_LLM_MODEL_NAME;
  if (oldLlmModel) {
  ...
  persist(
    (set, get) => {
      ...
      return {
        ...
        modelId: migratedData?.modelId || COMPANY_LLM_MODEL_NAME,
...
//                }
                ...
                // Keep browser-native TTS as the default narration path.
                // Do not auto-switch to a server TTS provider on first sync.
